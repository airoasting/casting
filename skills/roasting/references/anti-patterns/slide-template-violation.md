...
applies_to_categories:
  - 의사결정·전략  # p41 임원 PPT, p45 컨설팅 덱
  - 외부 커뮤니케이션  # p42 강의 자료
  - 마케팅  # p70 랜딩, p73 웹사이트, p74 이미지(슬라이드형)
...
- `direct` 모드 (p73 웹사이트 제작) — 풀스택 페이지라 컨테이너 쿼리·1200px 룰 강제 안 함. 별도 룰 적용.
...
3. **`direct` 모드(p73)에서 1920px 사용은 OK**
...
- `html_mode: direct` (p73 웹사이트 제작) — 풀스택 페이지, 별도 룰.
